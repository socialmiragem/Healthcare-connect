...
export const faqsData = [
    ...
    { title: "How quickly can I get coverage?", content: "Private healthcare offers more flexibility, shorter wait times, access to premium providers, and personalized service. You're not limited to network restrictions and can choose your preferred doctors and specialists." },
    { title: "Do I need a medical exam?", content: "Private healthcare offers more flexibility, shorter wait times, access to premium providers, and personalized service. You're not limited to network restrictions and can choose your preferred doctors and specialists." },
    { title: "Can I keep my current doctor?", content: "Private healthcare offers more flexibility, shorter wait times, access to premium providers, and personalized service. You're not limited to network restrictions and can choose your preferred doctors and specialists." },
    { title: "What if I have pre-existing conditions?", content: "Private healthcare offers more flexibility, shorter wait times, access to premium providers, and personalized service. You're not limited to network restrictions and can choose your preferred doctors and specialists." },
    { title: "How much can I save compared to traditional insurance?", content: "Private healthcare offers more flexibility, shorter wait times, access to premium providers, and personalized service. You're not limited to network restrictions and can choose your preferred doctors and specialists." },
]